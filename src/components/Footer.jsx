...
const Footer = () => {
  ...
  const socialLinks = [
    {
      name: "Email",
      url: "mailto:purnimarani086@gmail.com",
      icon: FaEnvelope,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12 mb-10">
            ...
            >
              ...
              <p className="text-gray-400 text-sm sm:text-base mb-4 leading-relaxed">
                Professional Video Editor specializing in creating engaging
                content for social media and digital platforms.
              </p>
              <p className="text-gray-500 text-xs sm:text-sm">
                Blending creativity and precision to produce exceptional video
                content.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <span className="break-all">purnimarani086@gmail.com</span>
              </a>
